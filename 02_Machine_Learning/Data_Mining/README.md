...
An econometric and statistical analysis of electoral behavior at the municipal level in Spain. Using a dataset of socioeconomic, demographic, and territorial variables (`DatosEleccionesEspaña.xlsx`), this repository implements an end-to-end data processing pipeline, continuous predictive modeling via **Linear Regression**, and binary classification via **Logistic Regression**.
...
* [Data Pipeline & Preprocessing](https://www.google.com/search?q=%23-data-pipeline--preprocessing)
* [Models & Results](https://www.google.com/search?q=%23-models--results)
* [1. Linear Regression (Abstention Rate)](https://www.google.com/search?q=%231-linear-regression-abstentionptge)
* [2. Logistic Regression (Left-Wing Victory)](https://www.google.com/search?q=%232-logistic-regression-izquierda)
...
This project investigates key socioeconomic and regional drivers behind electoral participation and political orientation across 8,117 Spanish municipalities. By applying statistical quality filters, joint outlier detection, and stepwise feature selection techniques, models were built to predict:
